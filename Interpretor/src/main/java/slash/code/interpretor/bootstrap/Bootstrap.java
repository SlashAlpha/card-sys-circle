...
//        cardList.add(card2);
//        Card card8 = new Card(UUID.randomUUID(), "Heart", 10, 0, "", 2);
//        cardList.add(card8);
//        Card card9 = new Card(UUID.randomUUID(), "Heart", 10, 1, "Jack", 2);
//        cardList.add(card9);
//        Card card10 = new Card(UUID.randomUUID(), "Heart", 10, 2, "Queen", 2);
//        cardList.add(card10);
//        Card card11 = new Card(UUID.randomUUID(), "Heart", 10, 3, "King", 2);
//        cardList.add(card11);
//        Card card12 = new Card(UUID.randomUUID(), "Heart", 10, 4, "Ace", 2);
//        cardList.add(card12);
//
//
...
//        System.out.println(interpretorService.analyseCards(interpretorService.getCards(7)));
